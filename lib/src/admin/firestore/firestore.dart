...
/// Firestore.
  ...
  extension type Firestore._(JSObject _) implements JSObject {
     ...
     */
    external JSPromise recursiveDelete(
      JSObject ref,
     ...
     */
    external JSPromise<T> runTransaction<T>(
  ...
  extension type Transaction._(JSObject _) implements JSObject {
     ...
     */
    @JS('get')
    external JSPromise<DocumentSnapshot> getDocument(DocumentReference documentRef);
  ...
  extension type BulkWriter._(JSObject _) implements JSObject {
     ...
     */
    external void onWriteError(
      JSFunction shouldRetryCallback
    );
  ...
  extension type BulkWriterOptions._(JSObject _) implements JSObject {
    ...
    external factory BulkWriterOptions({
      JSAny throttling
    });
  }
  ...
  extension type SortOptions._(JSObject _) implements JSObject {
    ...
    external factory SortOptions({
      bool? merge,
      JSArray<JSAny>? mergeFields
    });
  }
  ...
  extension type DocumentReference._(JSObject _) implements JSObject {
     ...
     */
    external JSPromise<WriteResult> delete([Precondition precondition,]);
     ...
     */
    external DocumentReference withConverter(
      FirestoreDataConverter? converter
    );
  }
